...
const PortfolioDetailHeading = ({
    ...
    return (
        <article className="lines max-h-max md:grid md:grid-cols-[1fr,1fr] lg:block">
            <h2 className="mb-6 grid text-40 text-GraylishDarkBlue first-letter:uppercase md:m-0 lg:mb-8 dark:text-White">
                {title}
            </h2>
            <p className="dark:text-DarkText col-start-2 col-end-3 row-start-1 row-end-3 mb-14 max-w-[400px] text-justify text-15 text-GraylishDarkBlue md:m-0 lg:mb-6 lg:max-w-[350px]">
                {desc}
            </p>
